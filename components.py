...
class Weapon(Component):
    def __init__(self, name, image, icon, reload_time_scheme, projectile_speed_scheme, move_pattern, damage_scheme, upgrade_costs, impact_sprite_img, freeze, recoil, impact):
        super().__init__(upgrade_costs, icon)
        self.name = name
        self.proj_img = image
...
def create_weapon_list():
    ...
    return np.array([
        Weapon('BOLT LASER', sm_laser_bolt_img, sm_laser_icon, sm_laser_reload_time_scheme, sm_laser_projectile_speed_scheme, ConstX(), sm_laser_damage_scheme, sm_laser_upgrade_costs, None, None, None, Impact(100, 200)),
        Weapon('GUM BLASTER', gumball_img, gum_blaster_icon, gumball_reload_time_scheme, gumball_projectile_speed_scheme, ConstX(), gumball_damage_scheme, gumball_upgrade_costs, create_gum_splat, 5.0, Recoil(np.array([-1.0, 0.0]), 1000), None),
        Weapon('LAVA BLASTER', lava_ball_img, lava_blaster_icon, lava_ball_reload_time_scheme, lava_ball_projectile_speed_scheme, ConstX(), lava_ball_damage_scheme, lava_ball_upgrade_costs, create_lava_splat, 5.0, None, None),
        Weapon('BEAM LASER', beam_laser_img, beam_laser_icon, beam_laser_reload_time_scheme, beam_laser_projectile_speed_scheme, TrackParent(), beam_laser_damage_scheme, beam_laser_upgrade_costs, None, None, None, None),
        Weapon('ICE RAY', ice_ray_img, ice_ray_icon, ice_ray_reload_time_scheme, ice_ray_projectile_speed_scheme, TrackParent(), ice_ray_damage_scheme, ice_ray_upgrade_costs, None, 0.016667, None, None),
        Weapon('MINE LAUNCHER', mine_img, None, mine_launcher_reload_time_scheme, mine_launcher_speed_scheme, ConstX(), mine_launcher_damage_scheme, mine_launcher_upgrade_costs, None, None, None, None),
        Weapon('ROCKETS', rocket_img, None, rocket_launcher_reload_time_scheme, rocket_launcher_speed_scheme, GuidedMissile(), rocket_launcher_damage_scheme, rocket_launcher_upgrade_costs, None, None, None, None)
    ])

#enemy
enemy_laser_template = Weapon('BOLT LASTER', enemy_laser_bolt_img, sm_laser_icon, sm_laser_reload_time_scheme, [-x for x in sm_laser_projectile_speed_scheme], ConstX(), sm_laser_damage_scheme, sm_laser_upgrade_costs, None, None, None, None)
enemy_fast_laser_template = Weapon('BOLT LASTER', enemy_laser_bolt_img, sm_laser_icon, sm_laser_enemy_reload_time_scheme, [-x for x in sm_laser_projectile_speed_scheme], ConstX(), sm_laser_damage_scheme, sm_laser_upgrade_costs, None, None, None, None)
