...
class Spawner:
    def __init__(self, enemy_type, location, speed, move_packs):
        ...
        self.speed = speed
        self.move_packs = move_packs

    def execute(self):
        scaled_hp = self.enemy_type.base_hp * len(players['all'])/2
        return Enemy(enemies,
            f"enemy_{len(enemies)}+1", 
            self.enemy_type.image, 
            scaled_hp, 
            self.location, 
            self.speed,
            None,
...
shooting_saucer = EnemyType(saucer_2_img, 200, enemy_laser_template)
...
class AllEnemiesCleared(Condition):
    def check(self, ctx):
        return len(enemies) == 0
    
class TimerExpired(Condition):
    def __init__(self, duration):
        self.duration = duration
    def check(self, ctx):
        return ctx.wave_timer >= self.duration
    
# events
class LevelEvent:
    def __init__(self, condition, command):
        self.complete = False
        self.condition = condition if isinstance(condition, Condition) else TimerExpired(condition)
...
class Wave:
    ...
    def execute(self, ctx):
        for event in self.events:
            if not event.complete and event.condition.check(ctx):
                event.execute()
...
class WaveSequencer:
    ...
    def current_wave(self):
        return self.waves[self.current_index]

    def update(self, dt):
        if self.complete:
            return
        
        self.current_wave.execute(self)
        self.wave_timer += dt
...
#     def generate(self, position, speed, move_pattern, start_move_packs=None):
#         scaled_hp = self.base_hp * len(players['all']) / 2
#         return Enemy(enemies,
#             f"enemy_{len(enemies)}+1", 
#             self.image, 
...
# basic_saucer = EnemyGenerator(saucer_1_img, 100, None)
# mini_saucer = EnemyGenerator(saucer_1_mini_img, 50, None)
# mini_red = EnemyGenerator(saucer_mini_red_img, 50, None)
# big_saucer = EnemyGenerator(saucer_1_big_img, 2000, None)
# shooting_saucer = EnemyGenerator(saucer_2_img, 200, copy.copy(enemy_laser_template))
# fast_shooting_saucer = EnemyGenerator(saucer_2_img, 100, copy.copy(enemy_fast_laser_template))
# boss_1 = EnemyGenerator(saucer_2_boss_img, 10000, copy.copy(enemy_laser_template))

# def caterpillar_group():
#     list_of_enemies = []
#     for i in range (40):
#         list_of_enemies.append(SpawnCommand(mini_red, (GAME_WIDTH + 128, tenth*8), 400, None, caterpillar_movement(i*0.25)))
#     return CommandGroup(*list_of_enemies)
...
#         SpawnCommand(mini_red, (GAME_WIDTH + 128, tenth*8), 300, None, [SeekNearestPlayer(None, None)]),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, 3* GAME_HEIGHT / 5), 180, None, [SeekNearestPlayer(None, None)] + [AvoidProjectile(150, 250)])),
# 2.0: caterpillar_group(),
# 4.0: CommandGroup(
...
# level_2_seq = {
# 0.0: CommandGroup(
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 2), 180, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 3), 120, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, 2 * GAME_HEIGHT / 3), 150, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*2), 360, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*8), 360, crazy_sine)),
# 5.0: CommandGroup(
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 2), 150, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 3), 300, sine_pattern),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, 2 * GAME_HEIGHT / 3), 180, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 4), 180, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, 2 * GAME_HEIGHT / 3), 150, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, 3 * GAME_HEIGHT / 4), 180, const_left),
...
# 15.0: CommandGroup(
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, GAME_HEIGHT / 2), 120, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 4), 180, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*4), 180, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*6), 180, const_left),
...
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, GAME_HEIGHT/2 - 64), 102, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, GAME_HEIGHT/2 + 64), 102, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 384, GAME_HEIGHT/2 - 128), 102, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 384, GAME_HEIGHT/2 + 128), 102, gentle_sine),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 512, GAME_HEIGHT/2 - 172), 102, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, GAME_HEIGHT/2 + 64), 180, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, GAME_HEIGHT/2 - 172), 180, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, GAME_HEIGHT/2 + 172), 180, const_left),
...
# 34.0: CommandGroup(
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 2), 132, const_left),
...
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 512, GAME_HEIGHT/2 + 172), 132, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*7), 180, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth*9), 180, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 420, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 256, tenth*2), 420, crazy_sine)),
# 8.0: CommandGroup(
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, GAME_HEIGHT / 2), 132, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, GAME_HEIGHT/2 - 64), 132, sine_pattern),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, GAME_HEIGHT/2 + 64), 132, const_left),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 384, GAME_HEIGHT/2 - 128), 132, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth), 180, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*5), 180, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*3), 180, sine_pattern),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth), 180, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*2), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 480, crazy_sine),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*3), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*5), 60, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*7), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*9), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth), 60, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*3), 60, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*5), 60, sine_pattern),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*7), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*9), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth*3), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth*9), 60, const_left)),
...
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*6), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*8), 480, crazy_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth), 60, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*3), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*5), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*9), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth*5), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 640, tenth*7), 60, const_left),
...
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 256, tenth*8), 60, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*1), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*9), 480, crazy_sine)),
# 5.0: CommandGroup(
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*3), 360, const_left),
...
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, tenth*2), 60, const_left),
...
# 25.0: CommandGroup(
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, tenth*2), 90, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 90, sine_pattern),
#         SpawnCommand(shooting_saucer, (GAME_WIDTH + 128, tenth*6), 90, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 90, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*1), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*9), 480, crazy_sine)),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*9), 60, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*2), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*4), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*6), 480, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*8), 480, crazy_sine),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*7), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*9), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*3), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*5), 60, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*7), 60, sine_pattern),
...
# 63.3333: SpawnCommand(big_saucer, (GAME_WIDTH + 256, tenth*5), 60, const_left),
# 66.6667: None
# }
...
#         SpawnCommand(big_saucer, (GAME_WIDTH + 128, tenth*6), 60, const_left),
...
#         SpawnCommand(big_saucer, (GAME_WIDTH + 128, tenth*2), 60, const_left),
...
#         SpawnCommand(big_saucer, (GAME_WIDTH + 256, tenth*8), 60, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*7), 600, const_left),
...
# 1.0: CommandGroup(
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*1), 300, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*1), 300, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*1), 300, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*9), 300, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*9), 300, gentle_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 384, tenth*9), 300, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 540, crazy_sine),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*2), 300, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*8), 300, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*3), 240, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*7), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*5), 180, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 512, tenth*5), 180, const_left),
...
# 30.0: CommandGroup(
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*1), 420, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*2), 420, const_left),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*9), 420, const_left),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 512, tenth*8), 420, const_left),
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*3), 540, crazy_sine),
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*7), 540, crazy_sine)),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*5), 120, const_left),
...
#         SpawnCommand(big_saucer,  (GAME_WIDTH + 256, tenth*4), 90, const_left),
#         SpawnCommand(big_saucer,  (GAME_WIDTH + 128, tenth*6), 90, gentle_sine),
#         SpawnCommand(big_saucer,  (GAME_WIDTH + 256, tenth*8), 90, const_left),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer, (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
#     # Boss enters
# 5.0: SpawnCommand(boss_1, (GAME_WIDTH + 512, tenth*5), 60, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*3), 120, const_left),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*7), 120, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*5), 90, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 150, const_left),
...
# 33.3333: CommandGroup(
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*2), 120, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*3), 150, sine_pattern),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*6), 120, const_left),
...
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*5), 240, const_left),
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 128, tenth*7), 240, const_left),
#         SpawnCommand(mini_saucer,  (GAME_WIDTH + 128, tenth*8), 540, crazy_sine),
...
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*3), 240, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*5), 180, sine_pattern),
#         SpawnCommand(basic_saucer, (GAME_WIDTH + 256, tenth*7), 240, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*3), 180, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*6), 180, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*9), 180, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*4), 120, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*8), 120, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
...
#         SpawnCommand(basic_saucer,         (GAME_WIDTH + 128, tenth*3), 360, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*5), 180, sine_pattern),
#         SpawnCommand(basic_saucer,         (GAME_WIDTH + 128, tenth*7), 360, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*2), 150, const_left),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*5), 120, sine_pattern),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 150, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*2), 180, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*5), 180, gentle_sine),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 180, const_left),
...
# 1.0: CommandGroup(
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*2), 120, gentle_sine),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*5), 120, const_left),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*8), 120, gentle_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*3), 210, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*5), 210, gentle_sine),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*7), 210, const_left),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*5), 180, gentle_sine),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*6), 180, const_left),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*7), 180, sine_pattern),
...
#         SpawnCommand(boss_1,               (GAME_WIDTH + 640, tenth*5), 90, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*2), 180, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*5), 180, sine_pattern),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*8), 180, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*3), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*7), 540, crazy_sine),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 210, const_left),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*6), 210, gentle_sine),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 210, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*2), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*3), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*4), 540, crazy_sine),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*3), 240, const_left),
...
#         SpawnCommand(basic_saucer,         (GAME_WIDTH + 256, tenth*6), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*9), 240, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*2), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*8), 540, crazy_sine)),
#     # Big saucers as shields for shooters behind them
# 7.5: CommandGroup(
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*2), 150, const_left),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*5), 150, gentle_sine),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*8), 150, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*2), 150, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*5), 150, gentle_sine),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*8), 150, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*4), 210, const_left),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*6), 210, sine_pattern),
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 256, tenth*8), 210, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*3), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*5), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*7), 540, crazy_sine),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*6), 210, const_left),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*8), 120, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*2), 240, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 240, sine_pattern),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*6), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*5), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*2), 300, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*3), 300, gentle_sine),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 300, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*7), 300, const_left),
...
# 6.6667: CommandGroup(
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*1), 180, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*1), 180, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*5), 180, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*5), 180, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 128, tenth*9), 180, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 384, tenth*9), 180, const_left),
...
#         SpawnCommand(boss_1,               (GAME_WIDTH + 768, tenth*5), 120, sine_pattern),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*2), 240, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 240, const_left),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*4), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*6), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 128, tenth*9), 540, crazy_sine)),
...
#         SpawnCommand(shooting_saucer,      (GAME_WIDTH + 128, tenth*6), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*5), 240, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*1), 240, const_left),
...
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*2), 180, const_left),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*4), 180, sine_pattern),
#         SpawnCommand(big_saucer,           (GAME_WIDTH + 256, tenth*6), 180, const_left),
...
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*2), 240, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*4), 240, sine_pattern),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 128, tenth*6), 240, const_left),
#         SpawnCommand(fast_shooting_saucer, (GAME_WIDTH + 256, tenth*8), 240, sine_pattern),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*1), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*2), 540, crazy_sine),
#         SpawnCommand(mini_saucer,          (GAME_WIDTH + 384, tenth*3), 540, crazy_sine),
